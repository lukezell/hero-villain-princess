...
function getVChoice() {
    if (hAlive && pAlive) {
        let vPrompt = "Villain, who do you want focus your attack on (add one point), the Hero: 1, or Princess: 2?";
...
function getHScore (){
    ...
    if (hChoice != 0) {
        ...
        hDecSum = `Did not subtract point from Princess`
        hGuess = false;
    }
}
function getPScore() {
...
function getVScore() {
    ...
    if (vChoice == 1) {
        ...
        vPrincessScore = vPrincessScore + 1;
